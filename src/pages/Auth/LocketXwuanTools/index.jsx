...
import StreakGeneratorTool from "./tools/StreakGeneratorTool";
import { Zap } from "lucide-react";

const toolsList = [
  {
    key: "streak-generator",
    label: "Tạo Chuỗi 1000 - 2000 Ngày",
    icon: <Zap className="text-amber-500" />,
    content: <StreakGeneratorTool />,
  },
  {
    key: "restore-streak",
