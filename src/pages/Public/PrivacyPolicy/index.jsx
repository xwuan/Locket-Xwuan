      ...
      <ul className="list-disc ml-6">
        ...
        <li className="mb-4">
          <p>
            ...
            this Agreement) refers to Locket Xwuan.
          </p>
        </li>
        <li className="mb-4">
          <p>
        ...
        <li className="mb-4">
          <p>
            <strong>Website</strong> refers to Locket Xwuan, accessible from{" "}
            <a
              href="https://locket-xwuan.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://locket-xwuan.com
            </a>
          </p>
        </li>
        <li className="mb-4">
      ...
      <ul className="list-disc ml-6">
        ...
        <li className="mb-4">
          <p>
            ...
            <a
              href="https://locket-xwuan.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://locket-xwuan.com/contact
            </a>
          </p>
        </li>
      </ul>
